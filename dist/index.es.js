...
var getCategoryCount = function (options, categoryL3) { return __async(function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                params = __assign({}, options.parameters, { start: 0, rows: 1, fields: 'alt_img', 'p-id': "categoryPathId:\"" + options.categoryPathL2 + ">" + categoryL3 + "\"" });
        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, axios.get(options.unbxdBase + "/category", { headers: options.headers, params: __assign({}, options.parameters, { start: calcStart, rows: calcRows }) })];
                case 3:
